...
data.forEach((whatever) => {
    articles.appendChild(createArticle(whatever.title, whatever.date, whatever.firstParagraph, whatever.secondParagraph, whatever.thirdParagraph));
});
...
function createArticle(title, date, firstParagraph, secondParagraph, thirdParagraph) {
    ...
    const entryOneP = document.createElement('p');
    const entryTwoP = document.createElement('p');
    const entryThreeP = document.createElement('p');
    const expButton = document.createElement('span');
    entry.appendChild(entryTitle);
    entry.appendChild(entryDate);
    entry.appendChild(entryOneP);
    entry.appendChild(entryTwoP);
    entry.appendChild(entryThreeP);
    ...
    entryTwoP.textContent = secondParagraph;
